...
export default function useAddRowDataTemp(classifier, problem, classifierKeyName) {
        ...
        axios
            ...
            .then(({ data }) => {
                ...
                Object.keys(objCl_data).map((key, index) => {
                    ...
                    // if (problem) {
                    //     if (index === 0 && classifier === classifierKeyName) {
                    //         objTempToAdd[key] = problem
                    //     } else {
                    //         objTempToAdd[key] = ""
                    //     }
                    // } else {
